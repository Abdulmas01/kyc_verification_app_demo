...
│   │   │   ├── document_capture_controller.dart
│   │   │   └── widgets/
...
│   │   │   ├── selfie_capture_controller.dart
│   │   │   └── widgets/
│   │   │       ├── face_oval_overlay.dart
...
```dart
// lib/core/api/models/verification_models.dart
...
final _router = GoRouter(
  ...
  routes: [
    ...
    GoRoute(
      ...
      builder: (_, __) => const DocumentCaptureScreen(),
    ),
    GoRoute(
      path: '/verify/selfie',
      builder: (_, __) => const SelfieCaptureScreen(),
    ),
    GoRoute(
...
```dart
// lib/features/document_capture/document_capture_screen.dart
