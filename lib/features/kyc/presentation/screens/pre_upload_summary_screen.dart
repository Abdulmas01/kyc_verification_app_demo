                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _SectionCard(
                      ...
                      lines: [
                        'Document quality label: ${report.documentQualityLabel ?? 'N/A'}',
                        'Document quality confidence: ${_formatDouble(report.documentQualityConfidence)}',
                        'Document avg inference: ${_formatDouble(report.documentAverageInferenceMs, suffix: ' ms')}',
                        'Document inference samples: ${report.documentInferenceSamples}',
                        'Document frame stride: ${report.documentFrameStride ?? 'N/A'}',
                        ...
                        'Face match attempted: ${report.mobileFaceMatchAttempted}',
                        'Face match available: ${report.mobileFaceMatchAvailable}',
                        'Face match score: ${_formatDouble(report.mobileFaceMatchScore)}',
                        'Face match threshold: ${_formatDouble(report.mobileFaceMatchThreshold)}',
                        ...
                        'Face match error: ${report.mobileFaceMatchError ?? 'None'}',
                      ],
                    ),
                    const SizedBox(height: AppSpacing.s12),
                    _SectionCard(
                    ...
                    const SizedBox(height: AppSpacing.s12),
                    _SectionCard(
                      title: 'Pending Backend Step',
                      lines: [
                        'Backend upload has not started yet.',
                        'This stage captures local thesis evidence before network verification.',
                        'Next step after Continue: start session, upload files, poll backend result.',
                      ],
                    ),
